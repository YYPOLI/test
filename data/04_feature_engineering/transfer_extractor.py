...
def run_transfer_analysis():
    ...
    output_path = os.path.join(BASE_PATH, "BigQuery_since20251230/analysis/transfer_analysis_result.csv")
...
def analyze_transfer_result():
    ...
    result_path = os.path.join(BASE_PATH, "BigQuery_since20251230/analysis/transfer_analysis_result_3months_0209.csv")
