...
def run_submitter_analysis():
    ...
    spender_path = os.path.join(BASE_PATH, "BigQuery_since20251230/analysis/spender_analysis_result_21months_0209.csv")
    ...
    FILE_PATH = os.path.join(BQ_PATH, "cleaned_data/train_data")
    ...
    output_path = os.path.join(BASE_PATH, "BigQuery_since20251230/analysis/original_submitter_analysis_result.csv")
...
def analyze_submitter_results():
    ...
    result_path = os.path.join(BASE_PATH, "BigQuery_since20251230/analysis/original_submitter_analysis_result_21months_0211.csv")
